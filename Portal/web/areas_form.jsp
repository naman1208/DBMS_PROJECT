...
<%
        ...
        if(request.getParameter("b2")!=null)
        {
            ...
            String[] s = msg.split(",");
            while(i!=s.length){
            stmt=con.prepareStatement("Insert into Areas values(?,?)");
            stmt.setString(1,request.getParameter("t0"));
            stmt.setString(2,s[i++]);
            stmt.executeUpdate();
            }
            
            response.sendRedirect("areas_form.jsp?tid="+tid);
        }
...
<html>
    ...
    <body>
        ...
        <div id="d1" style="width:100%;height:350px;">
            <form method="post" action=areas_form.jsp?tid=<%=tid%>>
                <table align="center">
                    <tr>
                        <th colspan="3">Area of Interests Form </th>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                         <td>Interested Areas: </td><td><textarea rows="3" cols="50" name="t1" id="t1"></textarea></td> 
                    </tr>
                    <tr>
