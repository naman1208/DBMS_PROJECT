...
<%
        ...
        if(request.getParameter("b2")!=null)
        {
            ...
            stmt.setString(6,request.getParameter("t3"));
            
            
            stmt.executeUpdate();
            msg="Expert form Complete";
            
            response.sendRedirect("books.jsp?tid="+tid);
        }
...
<html>
    ...
    <body>
        ...
        <div id="d1" style="width:100%;height:350px;">
            <form method="post" action=books.jsp?tid=<%=tid%>>
                <table align="center">
                    <tr>
                        <th colspan="3">Books Form</th>
                    </tr>
                    ...
                    <tr>
                        <td>Publisher:</td><td><input type="text" name="t3" id="t3" ></td><td></td>
                    </tr>
                    <tr>
                        <td>ISBN No.:</td><td><input type="text" name="t4" id="t4" ></td><td></td>
                    </tr>
                    <tr>
                        <td>Year:</td><td><input type="number" name="t5" id="t5" ></td><td></td>
                    </tr>
