...
<%
    ...
    ps=c.prepareStatement("select * from Chapters where TID='"+tid+"' order by Year asc;");
    rs2 = ps.executeQuery();
    ...
    <html>
        ...
        <body>
            ...
            <nav class="navbar navbar-default">
                <div id="menu_container" class="container-fluid">
                  <ul  id="nav" class="nav navbar-nav sf-menu">
                    ...
                    <li style="float:right;"><a href=chapters.jsp?tid=<%=tid%>>Add new</a></li>
            ...
            <% } %>
                ...
                <div class="content"> 
                    <h2>Chapters Published in Books</h2>
                    <% if (rs2.next() == false) { %>
