...
<%
        ...
        if(request.getParameter("b2")!=null)
        {
            ...
            response.sendRedirect("conference.jsp?tid="+tid);
        }
...
<html>
    ...
    <body>
        ...
        <div id="d1" style="width:100%;height:350px;">
            <form method="post" action=conference.jsp?tid=<%=tid%>>
                <table align="center">
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>Title:</td><td><input type="text" name="t1" id="t1" ></td><td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>End Date:</td><td><input type="date" name="t4" id="t4" ></td><td></td>
                    </tr>
                    <tr>
                        <td>Location:</td><td><input type="text" name="t5" id="t4" ></td><td></td>
                    </tr>
                    <tr>
                        <td>ISSN/ISBN No.:</td><td><input type="text" name="t6" id="t4" ></td><td></td>
                    </tr>
                    <tr>
                        <td>Publisher:</td><td><input type="text" name="t7" id="t4" ></td><td></td>
                    </tr>
