...
<%
   ...
   if(!((tid).equalsIgnoreCase(para)))
    ...
    ps=c.prepareStatement("select * from ExpertLecture where TID='"+tid+"'");
    rs2 = ps.executeQuery();
        ...
        <body>
            ...
            <nav class="navbar navbar-default">
                <div id="menu_container" class="container-fluid">
                  <ul  id="nav" class="nav navbar-nav sf-menu">
                    ...
                    <li class="active"><a href=invited_talk.jsp?tid=<%=tid%>>Invited Talk</a></li>
                    <% if(tid!="null"){ %>
                    
                    <li style="float:right;"><a href="index.jsp">Logout</a></li>
                    <li style="float:right;"><a href=expert_lecture.jsp?tid=<%=tid%>>New Invites</a></li>
            ...
            <% } %>
                ...
                <div class="content"> 
                    ...
                    <% if (rs2.next() == false) { %>
                    <h5>Click New Invites to update details </h5> <%} else { %>
                    <% do{ no++; %> 
                    <h14><strong><%=no%>. </strong> </h14>
                    <% if(rs2.getInt(6) - rs2.getInt(5) != 0) {%>
                    <a><%=rs2.getString(5)%> - <%=rs2.getString(6)%></a><% } else { %>
                    <a><%=rs2.getString(5)%> </a><% } %></br>
                    <h14 style="padding: 0 0 0 15px;"> Role: </h14><a > As <%= rs2.getString(2) %></a></br>
                    <h14 style="padding: 0 0 0 15px;"> Topic/Subjects: </h14><a> <%= rs2.getString(3)%></a></br>
                    <h14 style="padding: 0 0 0 15px;"> Location: </h14>  <a > <%= rs2.getString(4) %></a></br>
                    </br>
                    <% }while(rs2.next());} %>       
