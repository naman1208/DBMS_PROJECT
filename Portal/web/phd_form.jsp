...
<%
       ...
       if(!((tid).equalsIgnoreCase(para)))
        ...
        {
            stmt = c.prepareStatement("Insert into PhdThesis values(?,?,?,?,?,?)");
        ...
        else if(request.getParameter("b2")!=null)
        {
            ...
            response.sendRedirect("phd_form.jsp?tid="+tid);
...
<html>
    ...
    <body>
        ...
        <div id="d1" style="width:100%;height:350px;">
            <form method="post" action=phd_form.jsp?tid=<%=tid%>>
                <table align="center">
                    <tr>
                        <th colspan="3">Ph.D Students Form</th>
                    </tr>
                    ...
                    <tr>
                        <td>Research Topic: </td><td><input type="text" name="t3" id="t3" ></td><td></td>
                    </tr>
                    <tr>
