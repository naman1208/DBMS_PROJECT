...
<%
    ...
    ps=c.prepareStatement("select * from PhdThesis where TID='"+tid+"' order by EYear desc;");
    rs2 = ps.executeQuery();
                ...
                <div id="menu_container" class="container-fluid">
                  <ul  id="nav" class="nav navbar-nav sf-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="journals.php" id="journal" onclick="show('journal')">Journal Papers</a></li>
                    ...
                    <li style="float:right;"><a href=phd_form.jsp?tid=<%=tid%>>Add new</a></li>
