...
<%
        ...
        if(request.getParameter("b2")!=null)
        {
            ...
            response.sendRedirect("workshop_org.jsp?tid="+tid);
        }
...
<html>
    ...
    <body>
        ...
        <div id="d1" style="width:100%;height:350px;">
            <form method="post" action=workshop_org.jsp?tid=<%=tid%>>
                <table align="center">
                    <tr>
                        <th colspan="3">Workshops organized Form</th>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>Capacity:</td><td><input type="text" name="t1" id="t1" ></td><td></td>
                    </tr>
                    <tr>
                        <td>Title:</td><td><input type="text" name="t2" id="t2" ></td><td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Location:</td><td><input type="text" name="t5" id="t5" ></td><td></td>
                    </tr>
                    <tr>
